    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                switch (i %2){
                    case 0:
                        imageView.animate().alpha(1).scaleY(1).scaleX(1).translationX(500).rotation(360).start();
                        break;
                    case 1:
                        imageView.animate().alpha(0).scaleY(0).scaleX(0).translationX(0).rotation(0).start();
                        break;
                        default:
                }
                i++;
